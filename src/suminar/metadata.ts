...
const EXTRACTION_INSTRUCTIONS = [
  ...
  "PDF extraction sometimes corrupts ligatures, leaving a stray symbol or digit where ti, tt, fi, fl, or ff belongs (\"Poli)cs\" for \"Politics\", \"Honeycu8\" for \"Honeycutt\", \"e8orts\" for \"efforts\"). Restoring the evidently intended reading of such a corrupted word is faithful transcription, not guessing: repair it when the intended word is unambiguous from the visible text, and otherwise keep the printed form.",
